...
const TaskCard = ({task, index, handleTaskChanged}) => {
    ...
    const deleteTask = async (taskId) => {
        try {
            ...
            toast.error("Đã có lỗi xảy ra khi xóa nhiệm vụ.");
        }
    };
    ...
    const updateTask = async () => {
        try {
            ...
            toast.error("Đã có lỗi xảy ra khi cập nhật nhiệm vụ.");
        }
    }
    ...
    const toggleTaskCompleteButton = async () => {
        try {
            if(task.status === 'active') {
                ...
                toast.success(`"${task.title}" đã được thay đổi sang trạng thái chưa hoàn thành!`);
            }

            handleTaskChanged();
        } catch (error) {
            console.error("Lỗi khi cập nhật trạng thái nhiệm vụ:", error);
            toast.error("Đã có lỗi xảy ra khi cập nhật trạng thái nhiệm vụ.");
        }
    }
